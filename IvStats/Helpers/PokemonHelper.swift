...
class PokemonHelper {
    ...
    static let pokemonPrototypeDictionary: [PokemonId: PokemonPrototype] =
        [
            ...
            .hitmonlee: PokemonPrototype.init(pokemonId: .hitmonlee, pokemonType: [.pokemonTypeFighting], familyId: .familyTyrogue, parentId: .tyrogue, baseAttack: 224, baseDefense: 211, baseStamina: 100, height: 0.1875, weight: 6.225, nextEvolve: [], candyToEvolve: 0, buddyDistance: 5.0),
            .hitmonchan: PokemonPrototype.init(pokemonId: .hitmonchan, pokemonType: [.pokemonTypeFighting], familyId: .familyTyrogue, parentId: .tyrogue, baseAttack: 193, baseDefense: 212, baseStamina: 100, height: 0.175, weight: 6.275, nextEvolve: [], candyToEvolve: 0, buddyDistance: 5.0),
            ...
            .seadra: PokemonPrototype.init(pokemonId: .seadra, pokemonType: [.pokemonTypeWater], familyId: .familyHorsea, parentId: .horsea, baseAttack: 187, baseDefense: 182, baseStamina: 110, height: 0.15, weight: 3.125, nextEvolve: [.kingdra], candyToEvolve: 100, buddyDistance: 3.0),
            ...
            .kingdra: PokemonPrototype.init(pokemonId: .kingdra, pokemonType: [.pokemonTypeWater, .pokemonTypeDragon], familyId: .familyHorsea, parentId: .seadra, baseAttack: 194, baseDefense: 194, baseStamina: 150, height: 0.225, weight: 19.0, nextEvolve: [], candyToEvolve: 0, buddyDistance: 3.0),
            ...
            .tyrogue: PokemonPrototype.init(pokemonId: .tyrogue, pokemonType: [.pokemonTypeFighting], familyId: .familyTyrogue, parentId: .missingno, baseAttack: 64, baseDefense: 64, baseStamina: 70, height: 0.08875, weight: 2.625, nextEvolve: [.hitmonlee, .hitmonchan, .hitmontop], candyToEvolve: 25, buddyDistance: 5.0),
